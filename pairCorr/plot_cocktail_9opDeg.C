...
{   //TString f_data = "~/lustre/hades/user/icudrea/mar19/loop/phd/PairCorrection/EffCorrPair_mybins_oAngle9Mom100_alldays_fullCocktail.root";
    TString f_data = "~/lustre/hades/user/icudrea/mar19/loop/phd/PairCorrection/EffCorrPair_spectra_ag123ag_CBSmear_3sigma_oAngle9_alldays_040.root";
    ...
    TString f_rho  ="/u/icudrea/march19AgAg/submit/EffCorrection/cocktail/rho/scaled_smear_9oAngle_rho_allCC.root";
    TString f_w    ="/u/icudrea/march19AgAg/submit/EffCorrection/cocktail/w/scaled_smear_9oAngle_w_allCC.root";
    TString f_wd   ="/u/icudrea/march19AgAg/submit/EffCorrection/cocktail/wdalitz/scaled_smear_9oAngle_wD_allCC.root";
    TString f_ref  ="/u/icudrea/march19AgAg/submit/EffCorrection/Reference_ag1230ag.root";
    TString f_pi0  ="/u/icudrea/march19AgAg/submit/EffCorrection/cocktail/pi0/scaled_smear_SmearMomOnly_9oAngle_allCC.root";
   ...
   // h_pi0->Scale(5.26/5.61);
    ...
    setLegendCocktail( "Data 0-40%", h_data,
