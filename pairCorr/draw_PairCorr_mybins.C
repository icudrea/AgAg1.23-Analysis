...
void draw_PairCorr_mybins() {

  TFile *outputFile = new TFile("~/lustre/hades/user/icudrea/mar19/loop/phd/PairCorrection/EffCorrPair_mybins_oAngle9Mom100_alldays_wCGRho.root", "RECREATE");
...
//for CCtotal histo >Get("h_mass_ep_em_effCorr_1");if not use fh!!!!!!
    TH1D *h_mass_emem        = (TH1D*) file1->Get("h_mass_em_em_effCorr");
    TH1D *h_mass_epem        = (TH1D*) file1->Get("h_mass_ep_em_effCorr");
    TH1D *h_mass_epep        = (TH1D*) file1->Get("h_mass_ep_ep_effCorr");

    TH1D *h_mass_epem_mixEvt = (TH1D*) file1->Get("h_mass_ep_em_mixedEvents_effCorr");
    TH1D *h_mass_emem_mixEvt = (TH1D*) file1->Get("h_mass_em_em_mixedEvents_effCorr_");
    TH1D *h_mass_epep_mixEvt = (TH1D*) file1->Get("h_mass_ep_ep_mixedEvents_effCorr");
