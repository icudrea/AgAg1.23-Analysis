...
void draw_spectraRatio()
{

 //TFile *file1 = new TFile("EffCorr_spectras_ag123ag_CBSmear_3sigma_oAngle9MOmCut_alldays_OldCuts.root");
//  TFile *file1 = new TFile("EffCorr_spectras_ag123ag_CBSmear_3sigma_oAngle9MOmCut_alldays_OldCuts_wCentClassFix.root");
//  TFile *file2 = new TFile("EffCorrPair_spectras_ag123ag_CBSmear_3sigma_oAngle9MOmCut_alldays_OldCuts_wRhoInmed.root");


   TFile *file1 = new TFile("~/lustre/hades/user/icudrea/mar19/loop/phd/PairCorrection/EffCorrPair_spectra_ag123ag_CBSmear_3sigma_oAngle9Mom100_alldays_fullCocktail.root");
   TFile *file2 = new TFile("~/lustre/hades/user/icudrea/mar19/loop/phd/PairCorrection/EffCorrPair_spectra_ag123ag_CBSmear_3sigma_oAngle9Mom100_alldays_wCGRho.root");

  TH2D* h_Signal_epem_singleEff = (TH2D*) file1->Get("h_Signal_epem");
  TH2D* h_Signal_epem_pairEff   = (TH2D*) file2->Get("h_Signal_epem");

     setOPT_hists2D(h_Signal_epem_singleEff,"M_{ee} (GeV/c^{2})","Cocktail Corr./ CG Corr.",510,510);
//    setOPT_hists2D(h_Signal_epem_pairEff,"M_{ee} [GeV/c^{2}]","",510,510);
  ...
  TH1D* h_Signal_epem_singleEff_1d      =  (TH1D*) h_Signal_epem_singleEff->Clone("h_Signal_epem_singleEff_1d");
  h_Signal_epem_singleEff_1d->GetYaxis()->SetRangeUser(0,2.);

  TH1D* h_Signal_epem_pairEff_1d      =  (TH1D*) h_Signal_epem_pairEff->Clone("h_Signal_epem_pairEff_1d");
  h_Signal_epem_pairEff_1d->GetYaxis()->SetRangeUser(0,2.);

  h_Signal_epem_singleEff_1d->Divide(h_Signal_epem_pairEff);
 /// h_Signal_epem_singleEff_1d->Scale(100);
  h_Signal_epem_singleEff_1d->GetYaxis()->SetRangeUser(0, 2.);
  h_Signal_epem_singleEff_1d->Draw("l");
